...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  void _sendTestNotification() async {
    ...
    AndroidNotificationDetails(
      'channel_id', // Required positional argument: channelId
      'channel_name', // Required positional argument: channelName
      channelDescription: 'This is the channel description', // Named argument
      importance: Importance.max, // Named argument
      priority: Priority.high, // Named argument
    );
